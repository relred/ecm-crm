<x-layouts.app :title="__('Promotores')">
    <div class="flex w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <div class="relative overflow-x-auto sm:rounded-lg">
            <div class="my-7">
                <a href="{{ route('promoters.create') }}" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Registrar Promotor</a>
            </div>
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">
                                <flux:button
                                    href="{{ route('promoters.view', $user->id) }}"
