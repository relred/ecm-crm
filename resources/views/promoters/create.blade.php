<x-layouts.app :title="__('Registrar Promotor')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <h2>Crear Promotor</h2>
        <div class="w-full max-w-md mx-auto">

            <a href="{{ route('promoters') }}" class="inline-flex items-center font-medium text-blue-600 dark:text-blue-500 hover:underline">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
                </svg>
                Volver
            </a>
            <form method="POST" action="{{ route('promoters.store') }}" enctype="multipart/form-data">
                @csrf
                <div>
