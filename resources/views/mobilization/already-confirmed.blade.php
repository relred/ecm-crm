        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 flex flex-col items-center justify-center space-y-6">
                    ...
                    <h2 class="text-2xl font-semibold text-gray-900">Actividad ya confirmada</h2>
                    <p class="text-gray-600 text-center max-w-md">
                        Ya has confirmado tu actividad anteriormente. No es necesario que vuelvas a confirmar.
                    </p>
