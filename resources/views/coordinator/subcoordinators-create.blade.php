<x-layouts.app :title="__('Registrar Enlace')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <h2>Crear Enlace</h2>
        <div class="w-full max-w-md mx-auto">

            <a href="{{ route('coordinator.subcoordinators.index') }}" class="inline-flex items-center font-medium text-blue-600 dark:text-blue-500 hover:underline">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
                </svg>
                Volver
            </a>
            <form method="POST" action="{{ route('coordinator.subcoordinators.store') }}" enctype="multipart/form-data">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Correo Electrónico" name="email" />
                </div>
